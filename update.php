...
<?php include ("api/header.html");?>
      ...
      <a  class = "navbar-brand"><h4>ACTUALIZAR TICKET</h4></a>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card card-body">  
                    ...
                    <button  onclick="Update();" name = "create" class="btn btn-primary ">Actualizar Ticket</button>
                </div>   </div> 
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                <input type="text"  readonly class="form-control-plaintext form-control-sm" id="staticID" value="<?php echo $id ?>">
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <label for="staticCreate" class="col-sm-3 col-form-label col-form-label-sm">Actualizado:</label>
                              <div class="col-sm-9">
                                <input type="text" readonly class="form-control-plaintext form-control-sm" id="staticUpdate">
                              </div>
                            </div>
